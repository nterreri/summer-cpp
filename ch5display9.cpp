// ch5display9.cpp : Defines the entry point for the console application.
...
//Postcondition: The value of coast has been set to the
...
void introduction()
{
	...
	cout << "This program determines the retail price for\n"
		<< "an item at a Quick-Shop supermarker store.\n";
}
