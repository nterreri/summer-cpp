// ch4proj5.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	do
	{
		...
		cout << "The price of the item a year in the future is estimated to be:\n"
			<< pounds << pricefy << endl;

		cout << "The price of the item in two years time is estimated to be:\n"
			<< pounds << pricef2y << endl;
...
double futureprice_estimate(double current_price, double inflationrate)
{
	...
	return current_price + (current_price * (inflationrate / 100));
}